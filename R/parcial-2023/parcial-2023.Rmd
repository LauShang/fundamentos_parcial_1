...
```
**La distribución está sesgada a la derecha, ya que tiene largas colas a la izquierda, y colas cortas a la derecha **
...
**Estos porcentajes de cobertura menores al 95%, se deben a que la distribución, como observamos, se encuentra sesgada a la derecha**
